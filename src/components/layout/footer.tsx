    ...
    <footer className="bg-gray-900 border-t border-gray-800 py-8 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <div className="flex items-center space-x-2">
          ...
          />
          <span className="text-sm text-gray-400">© {new Date().getFullYear()} F1 Penca</span>
        </div>
        
        <div className="flex items-center space-x-6">          <Link 
          ...
          <Link 
            href="https://ko-fi.com/fedesanchezvidarte" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-sm font-medium text-gray-400 hover:text-gray-100 transition-colors"
          >
